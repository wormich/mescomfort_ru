...
<section class="section s-r1">
    <div class="wrap cf section__main">
        ...
        <div class="section__right">
            ...
            <div>
                <a href="#" class="b-btn _medium _upper btn-order" data-service="КОСМЕТИЧЕСКИЙ РЕМОНТ">Оставить заявку</a>
            </div>
        </div>
    </div>
...
<section class="section s-r2">
    <div class="wrap cf section__main">
            ...
            <div class="section__right">
                ...
                <div>
         <a href="#" class="b-btn _medium _upper btn-order" data-service="КАПИТАЛЬНЫЙ РЕМОНТ">Оставить заявку</a>
                </div>
            </div>
        </div>
    <?$APPLICATION->IncludeComponent(
...
<section class="section s-r3">
    <div class="wrap cf section__main">
        ...
        <div class="section__right">
            ...
            <div>
                <a href="#" class="b-btn _medium _upper btn-order" data-service="РЕМОНТ ПРЕМИУМ КЛАССА">Оставить заявку</a>
            </div>
        </div>
    </div>
    <?$APPLICATION->IncludeComponent(
...
<section class="section s-r6">
 ...
 <br>
		...
		<div class="price-type">
		 ...
		 <!--<div class="dl-block"><a href="/get-price/" class="dl icon-xls">скачать прайс-лист</a></div>-->
		<div>
 <a href="#" class="b-btn _medium _upper btn-order" data-service="РЕМОНТ ВАННОЙ КОМНАТЫ">Оставить заявку</a>
		</div>
	</div>
</div>
    <?$APPLICATION->IncludeComponent(
 ...
 <br>
	...
	<div class="section__right">
		<h4>
		 ...
		 <!--<div class="price-type">(косметический ремонт)</div>--> <!--<div class="dl-block"><a href="/get-price/" class="dl icon-xls">скачать прайс-лист</a></div>-->
		<div>
